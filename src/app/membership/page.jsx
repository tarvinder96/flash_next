...
export default async function AboutUsPage() {
  ...
  try {
    const res = await fetch(
      `https://actyvsolutions.com/flash_pack/public/api/get-membership-content`,
      {
        next: { revalidate: 0 },
      }
    );
    ...
    description = data?.data?.description
      ...
      : "membership content is unavailable";
  } catch (error) {
    console.error("Error fetching membership content:", error.message);
    description = "membership content is currently unavailable.";
  }
