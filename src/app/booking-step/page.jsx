...
export default async function AboutUsPage() {
  ...
  try {
    const res = await fetch(
      `https://actyvsolutions.com/flash_pack/public/api/get-book-content`,
      {
        next: { revalidate: 0 },
      }
    );
    ...
    description = data?.data?.description
      ...
      : "booking content is unavailable";
  } catch (error) {
    console.error("Error fetching booking content:", error.message);
    description = "booking content is currently unavailable.";
  }
